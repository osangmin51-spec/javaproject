...
paragraph("시연 영상은 실제 코드 설명보다 사용자가 보는 화면 흐름을 보여주는 용도이다. 이번 제출용 영상은 약 31초 길이로 접속, 종목 선택, 가격 그래프 확인, 매수, 보유 종목 손익 확인 장면이 들어 있다.")
add_table(["구간", "보여줄 화면", "설명"], [
    ["0~7초", "웹사이트 접속과 상단 요약", "Java 서버에서 웹앱이 실행되는 점"],
    ["7~14초", "종목 검색과 상세 화면", "종목 클릭 중심의 매매 흐름"],
    ["14~23초", "가격 그래프와 매수", "선택 종목의 가격 변화와 주문"],
    ["23~31초", "보유 탭과 손익", "매수 후 평가금액과 수익률 표시"],
], widths=[1.2, 2.4, 3.6])
