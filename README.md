...
사용자가 제공한 GitHub 미니프로젝트 구조를 기준으로 만든 Java 웹 버전입니다.

원본 참고:

- https://github.com/Kim-dong-young/KHStudy/tree/main/1_JAVA/JavaStudy/src/_miniproject

기존에 만들던 S&P 500 모의투자 웹앱과는 별도로, 이 앱은 원본 미니프로젝트의 기능만 담도록 구성했습니다.
...
- 원본 콘솔 메뉴를 웹 UI로 바꾸었기 때문에 입력 방식은 다르지만 기능 흐름은 원본을 따릅니다.
